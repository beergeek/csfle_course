...
def get_employee_key(client, kms, p, ns, id):
  ...
  if employee_key_id == None:
    try:
      ...
      master_key = {"region": "ap-southeast-2", "key": "5cb4ae1c-eee2-4359-a3c2-576f3de8f974"}
      employee_key_id = client_encryption.create_data_key(p, master_key, key_alt_names=[id])
