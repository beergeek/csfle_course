...
// Complete this
func decryptManual(<VARIABLES>) (bson.RawValue, error) {
...
// Decrypt all the data as required
// Complete this
func decryptData(<VARIABLES>) (bson.M, error) {
	return d, nil
}
...
func main() {
	...
	// Complete this
	output, err = decryptData(<VARIABLES>)
	if err != nil {
