...
public class App {
    ...
    // Complete this
    public UUID getEmployeeDekUUID(Object Complete_This) {
        ...
        if (employeeKeyDoc == null) {
            try (ClientEncryption clientEncryption = this.getClientEncryption(connectionString, keyvaultNamespace, kmsProvider)) {
                ...
                masterKey.append("region", new BsonString("<KEY_REGION>"))
                    .append("key", new BsonString("<KEY_UUID>"));
    ...
    // Complete this
    public boolean trashEmployeeKey(Object... VARIABLES) {
        try (ClientEncryption clientEncryption = this.getClientEncryption(connectionString, keyvaultNamespace, kmsProvider)) {
            ...
            clientEncryption.deleteKey(VARIABLE).subscribe(delSubscriber);
    ...
    public static void main( String[] args ) {
        ...
        try {
            // Complete this
            employeeKeyId = app.getEmployeeDekUUID(new Object());
        } catch (Exception eke) {
        ...
        try (MongoClient secureClient = app.getMdbClient(connectionString, 5000, false, autoEncryptionSettings)) {
            ...
            // Complete this
            app.trashEmployeeKey(VARIABLES);

            // Sleep here for 61 seconds
            // Complete this
